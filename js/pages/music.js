  ...
  getData: function(){
    ...
    this.formSearchElement.addEventListener('keypress', function(e) {
      ...
      if(e.keyCode == 13){
        ...
        e.preventDefault();
        //add loader to page
        document.querySelector('.listresults').innerHTML = '<div class="showbox"><div class="loader"><svg class="circular" viewBox="25 25 50 50"><circle class="path" cx="50" cy="50" r="20" fill="none" stroke-width="2" stroke-miterlimit="10"/projects/vigor/></svg></div></div>';
